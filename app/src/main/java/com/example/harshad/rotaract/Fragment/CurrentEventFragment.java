        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    FirebaseRecyclerAdapter<CustomAdapter,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<CustomAdapter, BlogViewHolder>(CustomAdapter.class, R.layout.current_event, BlogViewHolder.class, mDatabase) {
                        @Override
                        protected void populateViewHolder(BlogViewHolder viewHolder, final CustomAdapter model, final int position) {
                            ...
                            viewHolder.upload_user.setOnClickListener(new View.OnClickListener() {
                                @Override
